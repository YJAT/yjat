...
export default function AboutPage() {
  return (
    <div className='container mx-auto mb-4 px-4 py-8'>
      <h1 className='mb-8 text-3xl font-bold'>關於臺灣青年法律人協會</h1>
      ...
      <div className='grid grid-cols-1 gap-10 md:grid-cols-2'>
        ...
        <div>
          <h2 className='mb-4 text-3xl font-bold'>理事長的話</h2>
          <p className='mb-4'>致 所有青法之友們：</p>
          <p className='mb-4'>
            過去幾年，青法協持續與所有法律人站在一起，我們關心國會運作危機，我們站上街頭捍衛憲政法制，我們也不間斷撰文推廣民主自由的核心理念。
          </p>
          <p className='mb-4'>
          ...
          <p className='text-right'>臺灣青年法律人協會 理事長 劉家杭 敬上</p>
        </div>
      </div>
    </div>
  );
